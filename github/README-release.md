...
| 功能 | 说明 |
|------|------|
| 🧠 智能分析 | 自动理解任务类型、复杂度、技术要求 |
| 🎯 精准推荐 | 基于30+维度的模型匹配算法 |
| 💰 双币种 | 同时显示 ¥CNY 和 $USD 价格 |
| 🌍 全平台 | 支持国内外主流AI平台 |
| ⚡ 成本预估 | Token消耗和费用实时计算 |
...
| 任务类型 | 推荐模型 | 单次成本参考 |
|---------|---------|------------|
| 🖥️ 代码生成 | Claude 3.5 Sonnet, DeepSeek Coder | ¥0.005 - $0.01 |
| ✍️ 文案写作 | Qwen Long, GPT-4o-mini | ¥0 - ¥0.01 |
| 🌐 翻译 | DeepL, Google Translate | ¥0 - ¥0.001 |
| 🔍 搜索研究 | Perplexity, DeepSeek Search | ¥0.005 - ¥0.05 |
| 📈 数据分析 | Claude 3 Opus, GPT-4o | ¥0.01 - $0.05 |
...
```
$ smart-model-selector "调研特斯拉最近半年的股价变化"
...
🏆 推荐模型：
   🥇 免费首选: 通义千问 (¥0)
   💰 性价比之选: DeepSeek Search (¥0.005)
   💎 效果最佳: Perplexity ($0.01)
```
